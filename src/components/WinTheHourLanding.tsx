...
export default function WinTheHourLanding() {
  ...
  return (
    <div className="bg-[#0B0C10] text-[#FFFFFF] min-h-screen w-full overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen pt-24 px-6 bg-[#0B0C10]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center py-12">
          <div ref={heroTextRef} className="opacity-0">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight text-[#FFFFFF]">
              Transform Your Life,{" "}
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-6 bg-[#1F2025]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="feature-card bg-[#0B0C10] rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-[#3C4F65]">
              <div className="feature-icon w-24 h-24 mx-auto mb-6 bg-[#3C4F65] rounded-full flex items-center justify-center text-4xl relative">
                <span>⏰</span>
              ...
              <h3 className="text-2xl font-bold text-[#FFFFFF] mb-3 text-center">
                Win Every Hour
              </h3>
              <p className="font-semibold text-[#FFFFFF] mb-2 text-center opacity-90">
      ...
      {/* CTA Section 1 */}
      <section className="py-20 px-6 bg-[#0B0C10] text-center border-y border-[#1F2025]">
      ...
      {/* Testimonial Section */}
      <section id="about" className="py-20 px-6 bg-gradient-to-br from-[#3C4F65] via-[#1F2025] to-[#0B0C10]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-white/5 backdrop-blur-lg rounded-3xl p-10 border border-[#3C4F65]">
            <div className="text-6xl text-[#FF5E1A] mb-4 leading-none">"</div>
            <p className="text-lg leading-relaxed mb-6 text-[#FFFFFF]">
            ...
            <p className="text-xl font-bold text-[#FFFFFF]">Adam S.</p>
          </div>
      ...
      {/* Final CTA Section */}
      <section className="py-20 px-6 bg-[#0B0C10] text-center border-t border-[#1F2025]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#FFFFFF]">
            Ready to elevate your productivity?
          </h2>
      ...
      {/* Footer */}
      <footer id="contact" className="py-8 px-6 bg-[#0B0C10] border-t border-[#1F2025]">
        <div className="max-w-7xl mx-auto text-center text-[#FFFFFF] opacity-70">
