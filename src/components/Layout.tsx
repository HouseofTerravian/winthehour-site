      ...
      <nav className="fixed top-0 w-full bg-charcoal/95 backdrop-blur-md z-50 border-b border-steel">
        <div className="w-full max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <NavLink to="/dispatches" className={navClass}>
              Dispatches
            </NavLink>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-charcoal/95 backdrop-blur-md border-b border-steel">
            <div className="flex flex-col px-6 py-6 gap-5">
              ...
              <NavLink to="/dispatches" onClick={closeMobile} className={mobileNavClass}>
                Dispatches
              </NavLink>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/70 text-sm">
                ...
                <li>
                  <Link to="/store" className="hover:text-molten transition-colors">
                    Store
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/70 text-sm">
                ...
                <li>
                  <Link to="/dispatches" className="hover:text-molten transition-colors">
                    Dispatches
                  </Link>
                </li>
                <li>
