      ...
      <nav className="fixed top-0 w-full bg-[#0B0C10]/95 backdrop-blur-lg z-50 border-b border-[#1F2025]">
        <div className="w-full max-w-[1600px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-24 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link to="/contact" className="hidden md:inline-flex items-center justify-center whitespace-nowrap bg-[#FF5E1A] text-[#FFFFFF] px-6 py-2.5 rounded-full font-semibold shadow-lg hover:shadow-[#FF5E1A]/50 hover:bg-[#E55517] transition-all transform hover:scale-105 active:scale-95">
              Get Started
            </Link>
            <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#0B0C10]/95 backdrop-blur-lg border-b border-[#1F2025]">
            <div className="flex flex-col px-6 py-6 gap-5">
              <NavLink to="/" end onClick={closeMobile} className={mobileNavClass}>Home</NavLink>
              <NavLink to="/features" onClick={closeMobile} className={mobileNavClass}>Features</NavLink>
              <NavLink to="/about" onClick={closeMobile} className={mobileNavClass}>About</NavLink>
              <NavLink to="/store" onClick={closeMobile} className={mobileNavClass}>Store</NavLink>
              <NavLink to="/contact" onClick={closeMobile} className={mobileNavClass}>Contact</NavLink>
              <Link to="/contact" onClick={closeMobile} className="bg-[#FF5E1A] text-[#FFFFFF] px-6 py-3 rounded-full font-semibold text-center shadow-lg hover:bg-[#E55517] transition-all mt-2">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-20 lg:gap-28 mb-32">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-[#FFFFFF]/60 text-sm leading-relaxed">
                The productivity app that helps you transform your life, one hour at a time.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-6 text-[#FFFFFF]/60 text-sm">
                ...
                <li><Link to="/store" className="hover:text-[#FFFFFF] transition-colors">Store</Link></li>
              </ul>
            </div>
